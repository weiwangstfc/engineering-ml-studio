(function (global) {
  ...
  function buildValidationReportHtml(artifact, approvalInput) {
    ...
    <p class="note">Generated locally by Engineering ML Studio v1.0.11 (built on the Local Regression Studio engine). This report supports human review; it does not create regulatory certification.</p>
    ...
    <p><strong>Additional notes</strong><br>${esc(approval.notes || 'None')}</p><p class="footer">Original CSV data are not embedded in this report or in Engineering ML Studio project files.</p></body></html>`;
  }
